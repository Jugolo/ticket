...
class PageView implements P{
  ...
  private function changeOpen(int $id){
    ...
    if($data->open == 1){
      html_okay("The category is now closed");
    }else{
      html_okay("The category is now open");
    }
